...
const baseRequest = {
  ...
  function addGooglePayButton() {
    const paymentsClient = getGooglePaymentsClient();
    console.log("payment client",paymentsClient);
    const button =
   ...
   */
  function getGoogleTransactionInfo(payDataObj) {
    return {
      countryCode: 'US',
      currencyCode: 'USD',
  ...
  /**
   * Show Google Pay payment sheet when Google Pay payment event is recieved
   */
